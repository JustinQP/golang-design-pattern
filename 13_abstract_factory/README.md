...
客户端通过调用抽象工厂的方法来创建产品对象，不关心具体的工厂和产品对象是如何实现的。客户端只与抽象工厂和抽象产品进行交互，从而实现了客户端代码与具体对象创建逻辑的解耦。

![AbatractFactory.jpg](../.images/13_AbatractFactory_class.jpg)



![seq_AbatractFactory.jpg](../.images/13_AbatractFactory_seq.jpg)
